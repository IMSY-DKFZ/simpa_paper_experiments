...
global_settings[Tags.SPACING_MM] = 1.0
...
parallel_settings = define_parallelepiped_structure_settings(start_mm=[15, 25, 25],
                                                             edge_a_mm=[5, 10, 5],
                                                             edge_b_mm=[12, 18, 5],
                                                             edge_c_mm=[25, 0, 15],
                                                             molecular_composition=TISSUE_LIBRARY.epidermis())
...
ax.set_xticklabels(np.linspace(0, global_settings[Tags.DIM_VOLUME_X_MM], 6, dtype=int))
ax.set_yticklabels(np.linspace(0, global_settings[Tags.DIM_VOLUME_X_MM], 6, dtype=int))
ax.set_zticklabels(np.linspace(0, global_settings[Tags.DIM_VOLUME_X_MM], 6, dtype=int))
